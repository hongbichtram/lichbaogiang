...
export const Footer: React.FC = () => {
  return (
    <footer className="w-full py-2.5 sm:py-3 text-xs text-slate-500 dark:text-slate-400 border-t border-slate-200/70 dark:border-slate-800/80 mt-auto select-none bg-slate-50/50 dark:bg-slate-950/30 backdrop-blur-xs">
